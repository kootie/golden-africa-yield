...
const Footer = () => {
  return (
    <footer className="bg-navy-dark text-white pt-12 pb-8">
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <div className="flex items-center space-x-2 mb-4">
              <GoldIcon className="h-6 w-6 text-gold" />
              <span className="text-lg font-bold text-gold">GoldFund Africa</span>
            </div>
            <p className="text-gray-300 mb-4">
              Revolutionizing gold mining investments in Africa through transparent blockchain technology and IoT integration.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/how-it-works" className="text-gray-300 hover:text-gold transition-colors">How It Works</Link></li>
              <li><Link to="/technology" className="text-gray-300 hover:text-gold transition-colors">Our Technology</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><Link to="/compliance" className="text-gray-300 hover:text-gold transition-colors">Regulatory Compliance</Link></li>
              <li><Link to="/cookies" className="text-gray-300 hover:text-gold transition-colors">Cookie Policy</Link></li>
            </ul>
          </div>
        </div>

        <div className="border-t border-gray-700 mt-12 pt-8 text-center text-gray-400">
          <p>© 2025 GoldFund Africa. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
